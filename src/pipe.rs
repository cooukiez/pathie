...
use crate::{interface::Interface, offset_of, octree::{Octree, TreeNode, Light}, uniform::Uniform, Pref, DEFAULT_STORAGE_BUFFER_SIZE, DEFAULT_UNIFORM_BUFFER_SIZE};
...
impl Pipe {
    pub fn init(interface: &Interface, uniform: &mut Uniform, octree: &Octree, ) -> Self {
        unsafe {
            ...
            let light_buffer = BufferSet::new(interface, light_buffer_info, align_of::<Light>() as u64, &light_data, );
